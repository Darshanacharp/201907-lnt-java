...
import in.conceptarchitect.console.*; //get all class from console [NOT RECOMMEDED]
import in.conceptarchitect.furnitures.*;
import in.conceptarchitect.data.*;

//avoid confusion
import in.conceptarchitect.furnitures.Table; //RECOMMENDED
...
class App{
	...
	public static void main(String []args){
		...
		in.conceptarchitect.data.Table table2=new in.conceptarchitect.data.Table();
		screen.write(table2);

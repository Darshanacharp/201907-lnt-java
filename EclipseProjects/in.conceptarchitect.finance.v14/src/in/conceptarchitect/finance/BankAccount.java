...
public abstract class BankAccount {
	...
	private int accountNumber; //package scope
	private String name;
...
//	}
	...
	public void authenticate(String password) {
		if(! this.password.equals(password))
			throw new InvalidCredentialsException(getAccountNumber());
		//else
	...
	public void withdraw(double amount, String password) {
		...
		if(amount>balance) 
			throw new InsufficientBalanceException(getAccountNumber(), amount-balance);
	...
	public String toCsvString() {
		// TODO Auto-generated method stub
		return String.format("%s,%d,%s,%s,%f", getClass().getSimpleName(), accountNumber, name,password,balance);
	}

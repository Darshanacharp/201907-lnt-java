...
public class Bank {
	...
	public void showInfo(int accountNumber, String password) throws InvalidCredentialsException, InvalidAccountException {
	...
	public void deposit(int accountNumber, double amount) throws InvalidDenominationException, InvalidAccountException {
		// TODO Auto-generated method stub
		BankAccount a = findActiveAccount(accountNumber);
		a.deposit(amount);
	...
	private BankAccount findActiveAccount(int accountNumber) throws InvalidAccountException {
	...
	public void withdraw(int accountNumber, double amount, String password) throws InvalidAccountException, InvalidCredentialsException, InvalidDenominationException, InsufficientBalanceException {
		// TODO Auto-generated method stub
		BankAccount a=findActiveAccount(accountNumber);
	...
	public void transfer(int sourceAccount, double amount, String password, int targetAccount) throws BankingException{
		// TODO Auto-generated method stub
	...
	public void closeAccount(int accountNumber, String password) throws BankingException{
		// TODO Auto-generated method stub
	...
	public BankAccount getAccount(int a1, String password) throws InvalidAccountException, InvalidCredentialsException {
		// TODO Auto-generated method stub

...
public class ATM {
	...
	private void userDeposit() throws InvalidDenominationException, InvalidAccountException {
	...
	private void userWithdraw() throws InvalidAccountException, InvalidCredentialsException, InvalidDenominationException, InsufficientBalanceException {
	...
	private void userTransfer() throws BankingException {
		double amount=keyboard.readDouble("amount ?");
		String password=keyboard.readString("password?");
	...
	private void userShowBalance() throws InvalidCredentialsException, InvalidAccountException {
		String password=keyboard.readString("pin?");		
		bank.showInfo(accountNumber,password);
	}
	
	private void userClose() throws BankingException {
